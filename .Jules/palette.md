...
## 2025-06-13 - Icon-Only Interactive Elements Accessibility
...
**Action:** When implementing standalone icon buttons or links, consistently apply this four-layer pattern rather than relying solely on visual icons or screen reader text, ensuring no user cohort is left guessing the element's purpose.
