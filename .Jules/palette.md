...
**Action:** When creating or reviewing icon-only links or buttons, always verify the presence of a screen reader label, a hover tooltip (`title`), and a clear, high-contrast focus ring for keyboard users.
