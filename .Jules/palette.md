...
## 2025-06-12 - Toggle Button Accessibility
...
**Action:** When implementing toggles, use state (like `isOpen`) to conditionally render the accessibility text or `aria-label` to accurately describe the effect of interacting with the button in its current state.
