...
## 2025-06-13 - Dynamic Screen Reader Text for Toggle Buttons
...
**Action:** When implementing toggle elements, always bind the screen reader accessible name to the component state to announce the impending action, not the current state.
