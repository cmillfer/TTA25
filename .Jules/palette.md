...
## 2025-06-12 - Dynamic Toggle Button Accessibility
...
**Action:** When implementing toggle buttons, always map the state to the descriptive text and native `title` attribute, and prefer `focus-visible` to prevent unnecessary focus rings for mouse users.
