      ...
      <header className="sticky top-0 z-50 backdrop-blur-lg bg-brand-black/75 border-b border-dark-red/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <button
              className="flex items-center cursor-pointer group focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-red-500 rounded-sm"
            ...
            <nav className="hidden sm:flex items-center space-x-8">
              <button
                ...
                className="text-sm font-medium text-paper-light hover:text-primary-red transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-red-500 rounded-sm"
              >
                Music
              </button>
              <button
          ...
          <div className="pt-24 px-4">
            <nav className="flex flex-col items-center space-y-8">
              <button
                ...
                className="text-2xl font-bold uppercase font-mono tracking-wider text-paper-light hover:text-primary-red transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-red-500 rounded-sm"
              >
                Music
              </button>
              <button
