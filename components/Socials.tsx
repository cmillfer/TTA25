        ...
        {socialLinks.map(({ name, href, Icon }, index) => (
          <AnimateOnScroll key={name} delay={index * 100}>
            <a
              ...
              className="group flex flex-col items-center justify-center p-6 h-full bg-dark-red/10 rounded-lg border border-dark-red/50 hover:bg-dark-red/20 hover:border-primary-red focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-red focus-visible:ring-offset-2 focus-visible:ring-offset-brand-black transition-all duration-300 transform hover:-translate-y-1"
            >
