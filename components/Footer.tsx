      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex justify-center flex-wrap gap-6">
                <a href="https://www.youtube.com/@ToeTagAwards" target="_blank" rel="noopener noreferrer" title="YouTube" className="text-slate-400 hover:text-primary-red focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-red focus-visible:ring-offset-2 focus-visible:ring-offset-brand-black rounded-sm transition-colors">
