...
const Redacted: FC<{ children: ReactNode }> = ({ children }) => {
  return (
    <span
      className="bg-black text-black hover:bg-transparent hover:text-white focus-visible:bg-transparent focus-visible:text-white active:bg-transparent active:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-red transition-all cursor-help"
      tabIndex={0}
      title="Redacted text (hover or focus to reveal)"
    >
      <span className="sr-only">Redacted text: </span>
      {children}
    </span>
  );
};
